...
"""
    This module contains the project's base class
"""
import json
import csv
import turtle
...
class Base:
    ...
    def __init__(self, id=None):
        """ this function initializes every instances """
        if id is not None:
            self.id = id
        else:
            Base.__nb_objects += 1
    ...
    def save_to_file(cls, list_objs):
        ...
        if list_objs is None:
            ...
            for obj in list_objs:
                if hasattr(obj, 'to_dictionary') and \
                  callable(getattr(obj, 'to_dictionary')):
